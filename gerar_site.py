...
<body>
  ...
  <div class="wrap" id="app" style="display:none">
    ...
    <div class="foot">Concrelagos - Equipe Juridica - dados publicos (PNCP / Diario Oficial) - atualizado todo dia as 7h e 17h</div>
  </div>
...
document.querySelectorAll('.tabbtn').forEach(function(b){b.addEventListener('click',function(){
  ...
  if(b.getAttribute('data-t')==='mapa')setTimeout(mapa,60);
});});
